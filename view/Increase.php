                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <form class="form-horizontal box__director">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-4 col-md-4">
                                            <b>เพิ่มมูลค่าหุ้น(บาท/หุ้น)<span class="red">*</span></b>
                                            <div class="input-group">
                                                <div class="form-line">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            ...
                                            <div class="input-group">
                                                <div>
                                                    <input type="text" class="form-control" placeholder="30,100,000.00" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>เพิ่มมูลค่าหุ้น <br> (บาท/หุ้น)</th>
                                                <th>เพิ่มจํานวนหุ้น</th>
