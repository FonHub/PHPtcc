            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    <ul class="breadcrumb float-md-right">
                        ...
                        <li class="breadcrumb-item active">โครงสร้างการถือหุ้น</li>
                    </ul>
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr v-for="data in dataTableShow" :key="data.id">
                                            ...
                                            <td>2,500,0000</td>
                                            <td><a href="../assets/doc/DocStockLotRate.pdf"><button type="button" class="btn btn-raised btn-default waves-effect"> <i class="material-icons">mode_edit</i></button></a></td>
                                        </tr>
                                        <tr v-for="data in dataTableShow" :key="data.id">
                                            <td>2</td>
                                            <td>1/5/2564</td>
