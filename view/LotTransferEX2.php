                                            ...
                                            <div class="border-boxshadow p-3 ma-bt">
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-lg-4 col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <div>
                                                                <input type="text" class="form-control" placeholder="2,000,000" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <div>
                                                                <input type="text" class="form-control" placeholder="3,000,000" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-4">
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-lg-12 col-md-12 color-sum"><b>จำนวนหุ้นรวมทั้งหมด<span class="red">*</span></b>
                                                        <div class="input-group">
                                                            <div class="disabled">
                                                                <input type="text" class="color-sum" placeholder="1,000,000">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="border-boxshadow p-3 ma-bt">
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-3 col-md-3">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="form-line">
                                                                <input type="text" class="form-control" placeholder="10,000,0000" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6">
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-lg-12 col-md-12 color-sum"><b>จำนวนหุ้นรวมทั้งหมด<span class="red">*</span></b>
                                                        <div class="input-group">
                                                            <div class="disabled">
                                                                <input type="text" class="color-sum" placeholder="12,000,0000">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
